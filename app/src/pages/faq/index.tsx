      ...
      <OptionsProvider>
        ...
        <StyledFAQ>
          ...
          <StyledText>
            ...
            finance. Option tokens are traded and settled permissionlessly using
          ...
          <StyledText>
            ...
            investors have used options to manage and hedge risk because they
            are grant control over valuable assets for a fraction of a cost. Now
            anyone can use this instrument to manage risk for ETH and tokens
            issued on Ethereum (ERC-20). For further background on options and
            how they can help manage risk, please refer to the{' '}
            <Link
              href={
          ...
          <StyledSpacer size={24} />
          <StyledText>
            Let's say you are bearish on ETH and want to collect a premium, so
            you short a Call option. These are the steps you'd take: 1. Mint the
            Call option by depositing 1 ETH (underlying); receive Long Token,
            Short Token, and Redeem Token which is your claim on the underlying
            if the option never gets exercised.
          </StyledText>
          <StyledSpacer size={24} />
          <StyledText>
          ...
          <StyledText>
            ...
            redeem token to withdraw the original 1 ETH you deposited to mint
            the option.
          </StyledText>
          <StyledSpacer size={24} />
          <StyledText>
